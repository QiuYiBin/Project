                ...
                <form class="row" action="/register" method="post">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="请输入4-8位的数字和字母" name="username" pattern="^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{4,8}$" oninvalid="setCustomValidity('必须填写4-8位数字和字母');"
                oninput="setCustomValidity('');" id="reg-fn" required>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="请输入11位的手机号" name="phone" id="reg-ln" pattern="\d{11}" oninvalid="setCustomValidity('必须填写11位的手机号');"
                oninput="setCustomValidity('');" required >
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" placeholder="请输入带@的邮箱" name="email" id="reg-email" required>
                    @if(count($errors) > 0)
                        <div style="color:red">
                         <ul>
                             @foreach ($errors->all() as $error)
