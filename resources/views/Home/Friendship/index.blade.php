	...
	<div class="w">
		...
		<div class="link_box_a">
			...
			<div class="link_content">
				...
				<ul class="link_step">
					...
					<li>
						...
						<div class="margin_l_12">
							请先在贵网站做好文字友情链接：
							<br> 链接文字：我们还能抢救一下网站链接地址：
							<a href="//www.project.com" target="_blank">www.project.com</a></div>
					</li>
					<li>2.做好链接后，请在右侧填写申请信息。本网站只接受申请文字友情链接。</li>
					<li>
						<div class="float_Left"> 3.</div>
						<div class="margin_l_12">
							已经开通本站友情链接且内容健康，符合本站友情链接要求的网站，经后台管理员审核后，可以显示在此友情链接页面。</div>
					</li>
					<li>
				...
				<form action="friendship" method="post" id="frm_submit">
				<table class="link_table" width="309" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="348" valign="top">
							<textarea id="intro" name="title" cols="" rows="" class="w247h60" style="width: 319px; height: 150px;"></textarea>
							{{csrf_field()}}
						</td>
					</tr>
					<tr>
