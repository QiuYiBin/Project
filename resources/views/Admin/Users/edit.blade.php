    ...
    <form class="form-horizontal" role="form" action="/adminusers/{{$user->id}}" method="post"> 
     <div class="form-group" style="margin-top: 40px"> 
      ...
      <div class="col-md-3 col-xs-9"> 
       <input class="form-control" name="username" id="inputEmail1" type="text" placeholder="用户名" value="{{$user->username}}"/> 
      </div> 
     </div> 
     <div class="form-group" style="margin-top: 40px"> 
      <label class="col-lg-2 col-sm-2 control-label" for="inputEmail1">邮箱：</label> 
      <div class="col-md-3 col-xs-9"> 
       <input class="form-control" name="email" id="inputEmail1" type="text" placeholder="邮箱" value="{{$user->email}}"/> 
      </div> 
     </div> 
    <div class="form-group" style="margin-top: 40px"> 
      <label class="col-lg-2 col-sm-2 control-label" for="inputEmail1">电话：</label> 
      <div class="col-md-3 col-xs-9"> 
       <input class="form-control" name="phone" id="inputEmail1" type="text" placeholder="电话" value="{{$user->phone}}"/> 
      </div>
     </div>
     <div class="form-group" style="margin-top: 40px"> 
